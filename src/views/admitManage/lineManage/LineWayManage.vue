	...
	<div class="case">
			...
			<div class="car-way no-choice-box">
				...
				<div class="car-tabs">
					...
					<el-form label-width="80px" class="demo-ruleForm">
						<div class="search-manage small-search clear">
							<div class="search-l clear">
								<el-form-item label="业务城市">
									<el-input placeholder="请输入业务城市"></el-input>
								</el-form-item>
								<el-form-item label="小板种类">
									<el-select></el-select>
								</el-form-item>
					...
					<div class="car-way-nothing">
						...
						<el-table border style="width: 100%;">
							...
							<el-table-column label="业务城市">
							</el-table-column>
							<el-table-column label="小板种类">
							</el-table-column>
							<el-table-column label="板式">
							</el-table-column>
							<el-table-column label="报价详情">
							</el-table-column>
					...
					<div class="car-way-table">
						<el-table :data="tableData" border style="width: 100%">
							...
							<el-table-column prop="" label="业务城市" width="160">
							</el-table-column>
							<el-table-column prop="" label="小板种类" width="200">
							</el-table-column>
							<el-table-column prop="" label="板式" width="200">
							</el-table-column>
							<el-table-column prop="" label="报价详情" width="120">
							</el-table-column>
							<el-table-column prop="" label="创建时间" width="170">
							</el-table-column>
		...
		<el-dialog class="capacity-pop" title="新增专线信息" :visible.sync="addSmallLineInfo" width="74%" center>
			<div class="capacity-pop-in">
				...
				<el-form :model="addSmallLineInfoForm" :rules="addSmallLineInfoRules" ref="addSmallLineInfoForm" label-width="90px"
				 class="demo-ruleForm">
						...
						<div class="smallLine-r clear">
									...
									<div class="tc-quote">
										...
										<el-form-item label="起步价">
											<div class="quote-other">
												<el-input style="width: 20%;"></el-input>&nbsp;&nbsp;元，包含&nbsp;&nbsp;<el-input style="width: 15%;"></el-input>&nbsp;&nbsp;公里，每增加<i>1</i>公里，增加&nbsp;&nbsp;<el-input
												 style="width: 15%;"></el-input>&nbsp;&nbsp;元
											</div>
										</el-form-item>
									</div>
							...
							<div class="cj-quote-box line-table car-tabs">
								...
								<div class="car-way-nothing">
									...
									<el-table border style="width: 100%;">
										<el-table-column label="始发城市">
										</el-table-column>
										<el-table-column label="到达城市">
										</el-table-column>
										<el-table-column width="160px" label="调板时长（小时）">
										</el-table-column>
										<el-table-column label="小板种类">
										</el-table-column>
										<el-table-column label="板式">
										</el-table-column>
										<el-table-column width="140px" label="报价（元/公里）">
										</el-table-column>
										<el-table-column label="操作">
										</el-table-column>
									</el-table>
								...
								<div class="car-way-table">
									<el-table :data="tableData" border style="width: 100%;">
										<el-table-column prop="" width="160px" label="始发城市">
										</el-table-column>
										<el-table-column prop="" width="160px" label="到达城市">
										</el-table-column>
										<el-table-column width="160px" prop="" label="调板时长（小时）">
										</el-table-column>
										<el-table-column prop="" label="小板种类">
										</el-table-column>
										<el-table-column prop="" label="板式">
										</el-table-column>
										<el-table-column width="140px" prop="" label="报价（元/公里）">
										</el-table-column>
					...
					<div class="clear smallLine-box">
						...
						<div class="smallLine-r clear">
							...
							<div class="cj-quote-box line-table car-tabs">
								...
								<div class="car-way-table">
									<el-table :data="tableData" border style="width: 100%;">
										<el-table-column prop="" label="始发城市">
										</el-table-column>
										<el-table-column prop="" label="到达城市">
										</el-table-column>
										<el-table-column width="160px" prop="" label="调板时长（小时）">
										</el-table-column>
										<el-table-column prop="" label="小板种类">
