        ...
        <div class="capacity-manage">
            <div class="car-way line-choice">
                <div class="car-way-btn">
                    <el-button type="primary" @click="addCargoInsurance = true;addCargoInsuranceTitle='新增承运人责任险'" >新增承运人责任险</el-button>
                </div>
                <div class="car-tabs list-search-box">
                    ...
                    <el-tab-pane label="承运人责任险" name="2">
                        <el-form label-width="96px" class="demo-ruleForm" :model="carrierForm" :rules="carrierForm" ref="carrierForm">
                            <div class="search-manage small-search small-car-search clear">
                                <div class="search-l clear">
                                    <el-form-item label="保险单号" prop="">
                                        <el-input v-model="carrierForm.policyNo" placeholder="请输入保险单号"></el-input>
                                    </el-form-item>
                                    <el-form-item label="保险品牌" prop="" placeholder="请选择" >
                                        <el-select v-model="carrierForm.policyBrand">
                                            <el-option
                                    ...
                                    <el-form-item class="search-date" label="创建时间" prop="">
                                        <el-date-picker value-format="yyyy-MM-dd" v-model="carrierForm.createStartTime" type="date" placeholder="开始日期">
                                        </el-date-picker>
                                        <span>至</span>
                                        <el-date-picker value-format="yyyy-MM-dd" format="yyyy-MM-dd" v-model="carrierForm.createEndTime" type="date" placeholder="结束日期">
                                        </el-date-picker>
                                    </el-form-item>
                                    <el-form-item class="search-date" label="审核时间" prop="">
                                        <el-date-picker value-format="yyyy-MM-dd" v-model="carrierForm.auditStartTime" type="date" placeholder="开始日期">
                                        </el-date-picker>
                                        <span>至</span>
                                        <el-date-picker value-format="yyyy-MM-dd" v-model="carrierForm.auditEndTime" type="date" placeholder="结束日期">
                                        </el-date-picker>
                                    </el-form-item>
                                    <el-form-item  label="审核状态" prop="">
                                        <el-select v-model="carrierForm.auditStatus">
                                            <el-option
    ...
    export default {
        ...
        data() {
            return {
                activeIndex: '2',
                tabIndex: 2,
                addCargoInsuranceTitle:'新增承运人责任险',
        ...
        methods: {
            ...
            searchInsurance() {
                let that = this;
                if(that.carrierForm.createEndTime){
                    that.carrierForm.createEndTime = this.common.formatterDate(null, null, that.carrierForm.createEndTime) + " 23:59:59";
                }

                let formData = this.carrierForm;
            ...
            editInsurance(pkId) {
                ...
                this.addCargoInsuranceTitle = '编辑承运人责任险';
